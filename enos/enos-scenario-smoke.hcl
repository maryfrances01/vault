...
scenario "smoke" {
  description = <<-EOF
    The smoke scenario is designed to test a new Vault cluster as a fresh installation. According
    to the matrix variants, infrastructure is created and a new Vault cluster is provisioned. After
    provisioning Enos performs several quality verification.
  EOF
